...
const url = import.meta.env.VITE_MATRICULAUSA_SUPABASE_URL || import.meta.env.VITE_SUPABASE_URL;
const anonKey = import.meta.env.VITE_MATRICULAUSA_SUPABASE_ANON_KEY || import.meta.env.VITE_SUPABASE_ANON_KEY;
