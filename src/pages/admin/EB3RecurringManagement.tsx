    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2 uppercase tracking-tight">EB-3 Recurring Management</h1>
                    <p className="text-gray-400 text-sm sm:text-base">Manage monthly maintenance installments for EB-3 visa clients</p>
                </div>
                <Button
                    onClick={() => loadData()}
                    variant="outline"
