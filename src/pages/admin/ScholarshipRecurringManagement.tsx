    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            <div className="mb-6 flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-white mb-2">Scholarship Recurring Management</h1>
                    <p className="text-gray-400">Manage monthly maintenance installments for Scholarship clients</p>
                </div>
                <Button
                    onClick={() => loadData()}
                    variant="outline"
