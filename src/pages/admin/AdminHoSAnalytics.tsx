...
export function AdminHoSAnalytics() {
        ...
        async function loadData() {
            ...
            try {
                ...
                if (hosData) {
                    ...
                    // 2. Fetch team members by HoS team_id
                    ...
                    if (teamMemberList.length > 0) {
                        const sellerIds = teamMemberList.map(m => m.seller_id_public);
                        
                        // 3. Fetch team orders and commissions in parallel
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 p-4 sm:p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-gold-medium/10 pb-8">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-3xl font-bold text-white tracking-tight">
                            Performance de Gestão: {hos?.full_name || hosId}
                        </h1>
                    </div>
                ...
                <div className="bg-black/20 p-2 rounded-xl border border-gold-medium/10">
                    <PeriodFilter 
                        value={periodFilter} 
