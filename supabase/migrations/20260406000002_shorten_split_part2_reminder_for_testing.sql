-- Migration: Shorten split payment part 2 reminder timing for sandbox testing
-- Description: Reduces reminder delay to 1 minute and runs the cron job every minute
-- Date: 2026-04-06
...
BEGIN
  FOR split_record IN
    ...
    WHERE sp.part1_payment_status = 'completed'
      ...
      AND sp.part2_checkout_email_sent_at <= NOW() - INTERVAL '1 minute'
  LOOP
