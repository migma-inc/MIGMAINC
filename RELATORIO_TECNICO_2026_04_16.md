## Complemento pontual: ajuste de método de pagamento na invoice
...
Ação pontual e isolada. Não houve alteração de código — apenas manipulação direta de dado no banco e re-trigger da geração do PDF. Esse ajuste também está refletido na Atividade 1 do relatório consolidado abaixo.
